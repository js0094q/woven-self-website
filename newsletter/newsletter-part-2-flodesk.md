# Newsletter Part 2 — Flodesk Copy

## Email Subject Options

1. A quiet first look inside Unfolding Origami
2. The cover is here — and a first excerpt
3. A private excerpt from Loren’s upcoming memoir
4. A first look at Unfolding Origami: A Memoir

## Preview Text Options

1. The official cover is here, preorders are live, and I’m sharing a private excerpt with you first.
2. Thank you for being part of this early circle around Unfolding Origami.
3. Read a private first-look excerpt from Loren Galese’s upcoming memoir.
...
Use the updated Woven Self or Unfolding Origami campaign header image if available.
...
Insert the updated official cover image.

Use the same visual styling as the website’s “The Official Cover Is Here” section:

- warm neutral background
- dark book-cover blue accent
- serif headline
- restrained spacing
- centered cover
- clean CTA buttons
...
**Preorders matter more than most people realize.**

They help show early interest in the book, support launch visibility, and make it easier for the memoir to reach readers who may need it.
